...
const DATABASE_NAME = 'EduClaw-Database';
const _DATABASE_VERSION = 8;

/**
 * EduClaw Database Instance
 */
class EduClawDatabase extends Dexie {
  // Table definitions
...
export const db = new EduClawDatabase();
